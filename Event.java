...
public class Event implements Comparable<Event>{
	...
	public TranscationDelay txnDelay;
	public BlockDelay blockDelay;
	
	public final static int RECEIVE_BLOCK_EVENT = 1;			// receive block
	public final static int GENERATE_BLOCK_EVENT = 2;			// generate block
	public final static int RECEIVE_TRANSCATION_EVENT = 3;		// receive transaction
	public final static int GENERATE_TRANSCATION_EVENT = 4;	// generate transaction
	...
	public String getEventName(){
		...
		} else if(getEventType() == Event.RECEIVE_TRANSCATION_EVENT) {
			return "RECEIVE TRANSCATION";
		} else if(getEventType() == Event.GENERATE_TRANSCATION_EVENT){
